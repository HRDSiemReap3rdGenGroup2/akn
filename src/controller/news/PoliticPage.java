...
public class PoliticPage extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7494423269486867387L;
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			// category_id
			req.setAttribute("category_id",
					new ModuleDAO().getModuleId("B000103"));

			// paging
			int pagenumber = new NewsDAO().getTotalPage("B000103", 6);
			...
			list = new NewsDAO().getNewsList("B000103", 6, current_page);
