...
public class SportPage extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1590370713523160518L;
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			req.setAttribute("category_id",
					new ModuleDAO().getModuleId("B000201"));

			// paging
			int pagenumber = new NewsDAO().getTotalPage("B000201", 6);
			...
			list = new NewsDAO().getNewsList("B000201", 6, current_page);
